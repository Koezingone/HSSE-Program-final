...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Input Risk Control',
                    'url'  => 'risk-control/create',
                    'icon' => 'fas fa-fw fa-plus-circle',
                ],
                [
                    'text' => 'Lihat Semua Risk Control',
                    'url'  => 'risk-control',
                    'icon' => 'fas fa-fw fa-list',
                ],
            ],
        ...
        ['header' => 'PENGATURAN AKUN'], // Header pemisah

        [
            'text' => 'profile',
            'url'  => '#', // Nanti bisa diganti ke halaman profil
            'icon' => 'fas fa-fw fa-user',
        ],
        [
            'text' => 'change_password',
            'url'  => '#', // Nanti bisa diganti
    ...
    */
    ...
    'plugins' => [
        'Datatables' => [
            'active' => false, // Biarkan false, @section akan mengaktifkannya
            'files' => [
                // --- Core DataTables ---
                [
                    'type' => 'js',
                ...
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdn.datatables.net/buttons/1.6.1/js/buttons.bootstrap4.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => false,
